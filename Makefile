...
LDFLAGS := ""
LDFLAGS += -X=github.com/vs4vijay/matrix/pkg/version.SemVer=$(GIT_TAG)
LDFLAGS += -X=github.com/vs4vijay/matrix/pkg/version.GitCommit=$(GIT_COMMIT)
LDFLAGS += -X=github.com/vs4vijay/matrix/pkg/version.BuildTime=$(BUILD_TIME)
