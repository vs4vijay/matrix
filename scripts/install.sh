...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/vs4vijay/matrix/develop/scripts/install.sh | bash

PROJECT="matrix"
VERSION="1.0.0"
GITHUB_URL="https://github.com/vs4vijay/matrix"
BREW_TAP="vs4vijay/matrix/matrix"
